...
Bienvenido a la Wiki del Servidor Eureka de UM Tesorería.

## Propósito

El Servidor Eureka es el componente central de registro y descubrimiento de servicios para la arquitectura de microservicios de UM Tesorería.
...
""")
        ...
        with open(wiki_dir / 'Milestones.md', 'w', encoding='utf-8') as f:
            f.write("# Milestones del Servidor Eureka\n\n")
        ...
        with open(wiki_dir / 'Issues-Cerrados.md', 'w', encoding='utf-8') as f:
            f.write("# Issues Cerrados - Servidor Eureka\n\n")
